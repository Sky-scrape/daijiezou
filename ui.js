...
const LANE_KEYWORDS = {
  hardtech: ['AI', '人工智能', '大模型', '模型', 'DeepSeek', 'OpenAI', '芯片', '算法', '程序员', '代码', '编程', '机器人', '自动驾驶', '算力', '互联网', '折叠屏', '手机', '数码', '卫星', '系统', '科技'],
  biotech: ['药', '医疗', '医院', '癌', '疫苗', '手术', '疾病', '病毒', '患者', '临床', '健康', '医生', '吃药', '减肥'],
  beauty: ['医美', '化妆', '护肤', '美妆', '颜值', '整容', '美白', '防晒', '口红', '香水', '抗老', '变美'],
  livelihood: ['外卖', '食品', '餐饮', '超市', '物价', '快递', '菜', '粮', '水电', '燃气', '工资', '家长', '陪读', '学校', '教育', '高考'],
  entertain: ['明星', '电影', '剧', '综艺', '演唱会', '票房', '导演', '演员', '偶像', '粉丝', 'LPL', '电竞', '赛区', '决赛', '歌手', '游戏', '米哈游', '原神', '上映', '追更'],
  newretail: ['电商', '直播', '联名', '新品', '咖啡', '奶茶', '雪糕', '零食', '潮玩', '谷子', '发售', '售罄', '首发', '开店', '爆款'],
  military: ['军', '舰', '导弹', '战机', '国防', '演习', '武器', '航母', '雷达', '航天', '火箭'],
  industrial: ['制造', '工厂', '钢', '产线', '重工', '材料', '电池', '锂电', '汽车', '航空', '高铁', '能源', '电力', '征税', '涨价'],
  diversified: [],
};
const LANE_GENERIC = ['股', '基金', '理财', '央行', 'A股', '上市', '市值', '经济', '降息', '存款', '券商', '投资', '楼市', '房价', '收入', '征税', '关税', '利率', '涨价', '物价'];
const LANE_BRIDGE = {
